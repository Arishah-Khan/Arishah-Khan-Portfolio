...
export default function Skills() {
    ...
    return (
        <div className="bg-white px-6 md:px-10 lg:px-14 py-12 rounded-lg shadow-lg">
          ...
          {/* Updated grid layout */}
          <div className="mt-8 grid grid-cols-3 sm:grid-cols-4 gap-4 lg:grid-cols-6 sm:gap-6 text-center">
              {skills.map((skill, index) => (
                  ...
                  >
                      ...
                      <Image
                          ...
                          width={50}
                          height={50}
                          className="mb-4 w-[40px] h-[40px] sm:w[50px] sm:h-[50px] lg:w-[55px] lg:h-[50px]"
                      />
                      {/* Skill Name */}
